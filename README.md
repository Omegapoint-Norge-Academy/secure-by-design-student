...
If you have time left and want to learn more about this topic, we invite you to check out the complete workshop in [this](https://github.com/Omegapoint-Norge-Academy/secure-by-design) repository.

The workshop you just completed is part of this larger workshop as part 1, step 6. This longer workshop gives you the freedom to explore the parts that interest you, whether that is server-side or client-side authentication or security-testing.
